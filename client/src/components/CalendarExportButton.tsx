    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button 
          variant={variant} 
          size={size} 
          className="gap-2 bg-emerald-600 hover:bg-emerald-700 border-emerald-500 text-white font-semibold hover:border-emerald-600 transition-all shadow-sm hover:shadow-md"
        >
