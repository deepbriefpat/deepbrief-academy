...
const emailBaseTemplate = (content: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      <p><a href="https://thedeepbrief.co.uk/unsubscribe?email={{email}}" style="color: #6b7c93; text-decoration: underline;">Unsubscribe</a> from these emails</p>
...
export const pressureGuideWelcomeEmail = {
  subject: "Your Pressure Management Guide is Ready",
  body: emailBaseTemplate(`
    <div class="content">
      ...
      <a href="https://thedeepbrief.co.uk/pressure-management-guide.pdf" class="cta">Download Your Guide</a>
